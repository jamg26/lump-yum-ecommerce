...
<link rel="icon" href="img/logonadaw.png" sizes="16x16" type="image/png">
		...
		</script><link rel="icon" href="../img/logonadaw.png" sizes="16x16" type="image/png">
<style>
@font-face {
...
<?php include 'gilid.php';?>
	...
	<div id="rightcontent" style="position:absolute; top:20%;"> 
			<center><h2 id="kanimeh" style="position:relative; margin-bottom:5%; letter-spacing: 2px; font-size: 100px; color:#fff; text-shadow: 5px 2px #ff8000;">Summary report</h2></center>
  ...
  <div style="width:200px; position:fixed; margin-left:40%;">
      <form action="report.php" class="well" style="width:250px;">
          ...
          <input type="submit" onclick="return confirm('Are you sure you want to generate?');" class="btn btn-warning" value="generate">
      </form>
   <!-- <a href="print.php?from=<?php echo $from?>&to=<?php echo $to?>" target="_blank" id="gagmayay" class="btn btn-default">Print</a>
    -->  <a id="stylegamaysad" href="print.php?from=<?php echo $from?>&to=<?php echo $to?>" target="_blank" style="text-decoration:none;  box-shadow: 5px 8px #8889; z-index:-1000; margin-left:200px; margin-top:0px;  padding:15px 15px 15px 15px; position:absolute; letter-spacing: 1px; font-size: 20px; color:#fff; background-color:#ffaf00; border-radius: 25px; border: 2px solid #fff558;"  class="button">
			 <span>Print</span></a> 
...
<button type="submit" name="backupreset" onclick="return confirm('Do you want to reset the data?');" class="btn btn-primary" style="width:200px;">back up</button>
</form>
	</div>
	<?php }?>
