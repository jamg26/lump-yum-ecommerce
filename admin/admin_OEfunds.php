...
<?php include 'gilid.php';?>
	...
	<div id="rightcontent" style="position:absolute; top:20%;">
			<form method="post" action="insertexpense.php" class="well" style="position:relative; width:250px; margin-left:101%; margin-top:">
 			<center>
				<legend>Operating Expense</legend>
					<table>
						...
						<br>
						<br>
							<input type="submit" name="addexp" value="Submit" class="btn btn-warning" style="width:200px;">
					</table>
			</center>
		</form>
				 <form action="admin_OEfunds.php" class="well" style="position:relative; width:250px; margin-left:101%; margin-top:">
          <h2>Select date</h2>
          <label for="from">FROM:
		 ...
		 <center><h2 id="kanimeh" style="position:relative; margin-top:-50%; margin-bottom:4%; letter-spacing: 2px; font-size: 100px; color:#fff; text-shadow: 5px 2px #ff8000;">
			Operating Expense</h2></center>
 ...
 <a href='deleteoe.php?id=<?php echo $kanid;?>' onclick="return confirm('Are you sure you want to delete?');" class='btn btn-danger'><i class='icon-minus-sign icon-white'></i> Delete</a>
