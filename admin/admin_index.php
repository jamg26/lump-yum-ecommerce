...
<head>
    ...
    .gilid {
        ...
        box-shadow: 1px 8px 8px rgba(0, 0, 0, .5);
    }
    ...
    .btn-1 {
        background-image: linear-gradient(to right, #b68922 0%, #e7eb96 51%, #b68922 100%);
    }
    </style>
</head>
...
<body>
    ...
    <div id="admin" style="margin:5% 0% 5% 0%;">
        <form method="post" action="../function/admin_login.php" class="gilid"
            style="background-color:#fff; padding:2% 0% 0% 0%;  width:300pt; height:250pt;">

            <center>
                <legend id="stylegamaysad" style="font-size:50px;">Admin login</legend>
                <br />
                <table>
                    <tr><label id="stylegamaysad" style="font-size:20px;"><strong>Username</strong></label>
                        <input type="text" name="username" placeholder="Username" id="stylegamaysad" required>
                    </tr>
                    <br />
                    <tr><label id="stylegamaysad" style="font-size:20px;"><strong>Password</strong></label>
                        <input type="password" name="password" placeholder="Password" id="stylegamaysad" required>
                    </tr>

                    <input type="submit" name="enter" value="Enter" class="btn btn-1"
                        style="width:200px; background-color:#b68922;">
                </table>
            </center>
        </form>
