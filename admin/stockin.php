<!--Add Administrator facebox-->
  ...
  $id = $_GET['id'];
  ?>
	<div class="login_title" style="color:#000;"><span>Stock IN</span></div>
	<br>
		<form method="post" >
			<table class="login">
				...
				<tr><td><button name="stockin" type="submit" class="btn btn-block btn-large btn-warning"><i class="icon-ok-sign icon-white"></i> Save Data</button></td></tr>
			</table>
		</form>
  </div><!--/end facebox-->	
